...
available through the API. Wordplay and Grammar & Usage articles and
categories are also supported, and they are not available through the
API.

The quickest way to open the add-on is the default gesture:\
**Control+Alt+Shift+D**

You can invoke the add-on from anywhere to instantly look up the word
under the cursor or any currently selected word or phrase.
...
-   **Tested with:** NVDA 2026.1 through 2026.4\
...
2.  The word under the cursor or selected text will be used
    automatically.
3.  Press **Enter** to search using Dictionary mode.
4.  Use radio buttons to switch between Dictionary and Thesaurus.
5.  Use navigation commands (headings, lists, audio) to explore content.
...
### Global
  ...
  F1                    Open help file in browser

### Main Dialog

  Shortcut   Action
  ---------- ----------------------------
  Alt+E      Focus Search box
...
-   This add-on relies on the Merriam-Webster website structure.
